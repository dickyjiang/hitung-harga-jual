<template>
    <div class=" pt-4 px-4 bg- ">
          ...
          <div class="mb-12">
            <h2 class="text-center text-lg md:text-xl lg:text-2xl text-slate-400 font-semibold mb-4">
              Bingung menghitung harga jual makanan online?
            </h2>
            <p class="text-sm md:text-lg lg:text-xl text-center text-slate-500 md:max-w-3xl mx-auto">
